...
('dice_blessing', 'Dice Blessing', '주사위 축복', 'ダイスブレッシング', '骰子祝福', 'Common',
 'Convert all 6s to deal +5 bonus damage each.',
 '6이 나올 때마다 추가 데미지 +5.',
 '6が出るたびに追加ダメージ+5。',
 '每个6额外造成+5伤害。',
 'BEFORE_DAMAGE',
 '{"type": "six_bonus", "bonus": 5}',
 NULL),
...
('storm_chaser', 'Storm Chaser', '스톰 체이서', 'ストームチェイサー', '风暴追逐者', 'Rare',
 'Storm [1-2-3] deals +25 damage.',
 '스톰 [1-2-3] 완성 시 공격력 +25.',
 'ストーム[1-2-3]完成時に攻撃力+25。',
 '风暴[1-2-3]额外造成+25伤害。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Storm", "bonus": 25}',
 5),

('tactical_retreat', 'Tactical Retreat', '전술적 후퇴', '戦術的撤退', '战术撤退', 'Rare',
 'When taking 50+ damage, reduce it by 15.',
 '50 이상의 데미지를 받을 때 15 감소.',
 '50以上のダメージを受ける時15減少。',
 '受到50以上伤害时减少15。',
 'PASSIVE',
 '{"type": "heavy_hit_reduction", "threshold": 50, "reduction": 15}',
 5),

('adrenaline_rush', 'Adrenaline Rush', '아드레날린 러시', 'アドレナリンラッシュ', '肾上腺素', 'Rare',
 'Deal +20 damage when HP is below 40.',
 'HP가 40 이하일 때 데미지 +20.',
 'HPが40以下の時ダメージ+20。',
 'HP低于40时伤害+20。',
 'BEFORE_DAMAGE',
 '{"type": "low_hp_bonus", "threshold": 40, "bonus": 20}',
 5),

('fortune_favor', 'Fortune''s Favor', '행운의 가호', '幸運の加護', '幸运眷顾', 'Rare',
 '30% chance to deal +30 bonus damage.',
 '30% 확률로 추가 데미지 +30.',
 '30%の確率で追加ダメージ+30。',
 '30%几率额外伤害+30。',
 'BEFORE_DAMAGE',
 '{"type": "luck_bonus", "chance": 0.3, "bonus": 30}',
 5),
...
('ace_seeker', 'Ace Seeker', '에이스 시커', 'エースシーカー', '王牌寻找者', 'Epic',
 'Ace [1-1-1] deals +40 damage.',
 '에이스 [1-1-1] 완성 시 공격력 +40.',
 'エース[1-1-1]完成時に攻撃力+40。',
 'Ace[1-1-1]额外造成+40伤害。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Ace", "bonus": 40}',
 10),
...
('vengeance', 'Vengeance', '복수', 'ヴェンジェンス', '复仇', 'Epic',
 'Deal +40 damage after taking 60+ damage in previous turn.',
 '이전 턴에 60 이상의 데미지를 받으면 다음 턴 데미지 +40.',
 '前のターンで60以上のダメージを受けると次のターンダメージ+40。',
 '上回合受到60以上伤害后伤害+40。',
 'BEFORE_DAMAGE',
 '{"type": "revenge_bonus", "threshold": 60, "bonus": 40}',
 10),

('lucky_sevens', 'Lucky Sevens', '럭키 세븐', 'ラッキーセブン', '幸运七', 'Epic',
 'If dice sum is 7 or 14, deal +50 damage.',
 '주사위 합이 7 또는 14이면 데미지 +50.',
 'サイコロの合計が7または14ならダメージ+50。',
 '骰子总和为7或14时伤害+50。',
 'BEFORE_DAMAGE',
 '{"type": "sum_bonus", "sums": [7, 14], "bonus": 50}',
 10),

('elemental_fury', 'Elemental Fury', '원소의 분노', 'エレメンタルフューリー', '元素狂怒', 'Epic',
 'No Hand deals +35 damage.',
 '노 핸드 시 데미지 +35.',
 '役なしの時ダメージ+35。',
 '无手牌时伤害+35。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "NoHand", "bonus": 35}',
 10),
...
('omega_strike', 'Omega Strike', '오메가 스트라이크', 'オメガストライク', '欧米伽打击', 'Legendary',
 'If you win the turn by 100+ damage difference, enemy loses next turn.',
 '100 이상의 데미지 차이로 턴 승리 시 적 다음 턴 상실.',
 '100以上のダメージ差でターン勝利時、敵は次のターンを失う。',
 '伤害差超过100获胜时敌人失去下回合。',
 'AFTER_DAMAGE',
 '{"type": "overwhelming_victory", "threshold": 100}',
 15),

('phoenix_rebirth', 'Phoenix Rebirth', '불사조의 부활', 'フェニックスリバース', '凤凰重生', 'Legendary',
 'Once per battle, revive with 50 HP when reduced to 0.',
 '전투당 1회, HP가 0이 되면 50 HP로 부활.',
 '戦闘ごとに1回、HPが0になると50HPで復活。',
 '每场战斗1次，HP降至0时以50HP复活。',
 'PASSIVE',
 '{"type": "revive", "hp": 50, "uses": 1}',
 15),
