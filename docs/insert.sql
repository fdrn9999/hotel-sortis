...
('quick_learner', 'Quick Learner', '빠른 학습', 'クイックラーナー', '快速学习', 'Common',
 'Gain +2 damage for each turn passed.',
 '턴이 지날 때마다 데미지가 +2 증가합니다.',
 'ターンごとにダメージが+2増加します。',
 '每回合伤害+2。',
 'BEFORE_DAMAGE',
 '{"type": "scaling_damage", "per_turn": 2}',
 NULL),

('lucky_start', 'Lucky Start', '행운의 시작', 'ラッキースタート', '幸运开局', 'Common',
 'First roll of the battle deals +5 damage.',
 '전투의 첫 번째 굴림에 데미지 +5.',
 '戦闘の最初のロールでダメージ+5。',
 '战斗首次掷骰伤害+5。',
 'BEFORE_DAMAGE',
 '{"type": "first_turn_bonus", "bonus": 5}',
 NULL),
...
('defensive_stance', 'Defensive Stance', '방어 자세', 'ディフェンシブスタンス', '防御姿态', 'Common',
 ...
 '受到伤害减少10%。',
 'PASSIVE',
 '{"type": "damage_reduction", "reduction": 0.1}',
 NULL),

('dice_blessing', 'Dice Blessing', '주사위 축복', 'ダイスブレッシング', '骰子祝福', 'Common',
 'Each 6 in your roll deals +2 bonus damage.',
 '6이 나올 때마다 추가 데미지 +2.',
 '6が出るたびに追加ダメージ+2。',
 '每个6额外造成+2伤害。',
 'BEFORE_DAMAGE',
 '{"type": "six_bonus", "bonus": 2}',
 NULL),

('survivor', 'Survivor', '생존자', 'サバイバー', '幸存者', 'Common',
 'Heal 5 HP at the end of each turn.',
 '매 턴 종료 시 HP 5 회복.',
 '毎ターン終了時にHP5回復。',
 '每回合结束时回复5HP。',
 'TURN_END',
...
('focused_mind', 'Focused Mind', '집중된 정신', '集中する精神', '专注心灵', 'Common',
 'Gain +3 damage for each same number in roll.',
 '같은 숫자가 나올 때마다 데미지 +3.',
 '同じ数字が出るたびにダメージ+3。',
 '每个相同数字伤害+3。',
 'BEFORE_DAMAGE',
 '{"type": "same_number_bonus", "bonus": 3}',
 NULL),
...
('pair_master', 'Pair Master', '페어 마스터', 'ペアマスター', '对子大师', 'Rare',
 'Pair hands deal +10 damage.',
 '페어 족보 완성 시 공격력 +10.',
 'ペア役完成時に攻撃力+10。',
 '对子手牌额外造成+10伤害。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Pair", "bonus": 10}',
 5),
...
('greed_dice', 'Greed Dice', '탐욕의 주사위', '強欲のダイス', '贪婪骰子', 'Rare',
 'Triple hands deal +10 damage.',
 '트리플 족보 완성 시 공격력 +10.',
 'トリプル役完成時に攻撃力+10。',
 '三同号额外造成+10伤害。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Triple", "bonus": 10}',
 5),
...
('pressure_point', 'Pressure Point', '급소 공격', '急所攻撃', '要害攻击', 'Rare',
 'Deal +8 damage to enemies below 30 HP.',
 '적 HP가 30 이하일 때 데미지 +8.',
 '敵のHPが30以下の時ダメージ+8。',
 '敌人HP低于30时伤害+8。',
 'BEFORE_DAMAGE',
 '{"type": "execute_bonus", "threshold": 30, "bonus": 8}',
 5),
...
('momentum', 'Momentum', '기세', 'モメンタム', '气势', 'Rare',
 'Consecutive wins increase damage by +5 (max +15).',
 '연속 승리 시 데미지 +5 (최대 +15).',
 '連続勝利時にダメージ+5（最大+15）。',
 '连续胜利时伤害+5（最多+15）。',
 'BEFORE_DAMAGE',
 '{"type": "streak_bonus", "per_win": 5, "max": 15}',
 5),
...
('storm_chaser', 'Storm Chaser', '스톰 체이서', 'ストームチェイサー', '风暴追逐者', 'Rare',
 'Storm [1-2-3] deals +10 damage.',
 '스톰 [1-2-3] 완성 시 공격력 +10.',
 'ストーム[1-2-3]完成時に攻撃力+10。',
 '风暴[1-2-3]额外造成+10伤害。',
 'BEFORE_DAMAGE',
...
('tactical_retreat', 'Tactical Retreat', '전술적 후퇴', '戦術的撤退', '战术撤退', 'Rare',
 'When taking 30+ damage, reduce it by 8.',
 '30 이상의 데미지를 받을 때 8 감소.',
 '30以上のダメージを受ける時8減少。',
 '受到30以上伤害时减少8。',
 'PASSIVE',
 '{"type": "heavy_hit_reduction", "threshold": 30, "reduction": 8}',
 5),

('adrenaline_rush', 'Adrenaline Rush', '아드레날린 러시', 'アドレナリンラッシュ', '肾上腺素', 'Rare',
 'Deal +10 damage when HP is below 30.',
 'HP가 30 이하일 때 데미지 +10.',
 'HPが30以下の時ダメージ+10。',
 'HP低于30时伤害+10。',
 'BEFORE_DAMAGE',
 '{"type": "low_hp_bonus", "threshold": 30, "bonus": 10}',
 5),

('fortune_favor', 'Fortune''s Favor', '행운의 가호', '幸運の加護', '幸运眷顾', 'Rare',
 '30% chance to deal +10 bonus damage.',
 '30% 확률로 추가 데미지 +10.',
 '30%の確率で追加ダメージ+10。',
 '30%几率额外伤害+10。',
 'BEFORE_DAMAGE',
 '{"type": "luck_bonus", "chance": 0.3, "bonus": 10}',
 5),
...
('storm_seeker', 'Storm Seeker', '스톰 시커', 'ストームシーカー', '风暴追寻者', 'Epic',
 'Storm [1-2-3] deals +20 damage (total 40).',
 '스톰 [1-2-3] 완성 시 공격력 +20 (총 40).',
 'ストーム[1-2-3]完成時に攻撃力+20（合計40）。',
 '风暴[1-2-3]额外造成+20伤害（总计40）。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Storm", "bonus": 20}',
 10),
...
('straight_shooter', 'Straight Shooter', '스트레이트 슈터', 'ストレートシューター', '顺子射手', 'Epic',
 'Straight [4-5-6] deals +15 damage (total 65).',
 '스트레이트 [4-5-6] 완성 시 공격력 +15 (총 65).',
 'ストレート[4-5-6]完成時に攻撃力+15（合計65）。',
 '顺子[4-5-6]额外造成+15伤害（总计65）。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Straight", "bonus": 15}',
 10),
...
('chain_reaction', 'Chain Reaction', '연쇄 반응', '連鎖反応', '连锁反应', 'Epic',
 'If you deal 40+ damage, deal additional 10 damage.',
 '40 이상의 데미지를 가하면 추가로 10 데미지.',
 '40以上のダメージを与えると追加で10ダメージ。',
 '造成40以上伤害时额外造成10伤害。',
 'AFTER_DAMAGE',
 '{"type": "threshold_bonus", "threshold": 40, "bonus": 10}',
 10),
...
('ace_seeker', 'Ace Seeker', '에이스 시커', 'エースシーカー', '王牌寻找者', 'Epic',
 'Ace [1-1-1] deals +15 damage.',
 '에이스 [1-1-1] 완성 시 공격력 +15.',
 'エース[1-1-1]完成時に攻撃力+15。',
 'Ace[1-1-1]额外造成+15伤害。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Ace", "bonus": 15}',
 10),
...
('battle_hardened', 'Battle Hardened', '전투 경험', 'バトルハードゥン', '身经百战', 'Epic',
 ...
 '所有受到伤害减少25%。',
 'PASSIVE',
 '{"type": "damage_reduction", "reduction": 0.25}',
 10),

('critical_eye', 'Critical Eye', '치명적 시선', 'クリティカルアイ', '致命之眼', 'Epic',
 '25% chance to deal 2x damage.',
 '25% 확률로 2배 데미지.',
 '25%の確率で2倍ダメージ。',
 '25%几率造成2倍伤害。',
 'BEFORE_DAMAGE',
 '{"type": "critical", "chance": 0.25, "multiplier": 2}',
 10),
...
('vengeance', 'Vengeance', '복수', 'ヴェンジェンス', '复仇', 'Epic',
 'Deal +15 damage after taking 30+ damage in previous turn.',
 '이전 턴에 30 이상의 데미지를 받으면 다음 턴 데미지 +15.',
 '前のターンで30以上のダメージを受けると次のターンダメージ+15。',
 '上回合受到30以上伤害后伤害+15。',
 'BEFORE_DAMAGE',
 '{"type": "revenge_bonus", "threshold": 30, "bonus": 15}',
 10),

('lucky_sevens', 'Lucky Sevens', '럭키 세븐', 'ラッキーセブン', '幸运七', 'Epic',
 'If dice sum is 7 or 14, deal +15 damage.',
 '주사위 합이 7 또는 14이면 데미지 +15.',
 'サイコロの合計が7または14ならダメージ+15。',
 '骰子总和为7或14时伤害+15。',
 'BEFORE_DAMAGE',
 '{"type": "sum_bonus", "sums": [7, 14], "bonus": 15}',
 10),

('elemental_fury', 'Elemental Fury', '원소의 분노', 'エレメンタルフューリー', '元素狂怒', 'Epic',
 'No Hand deals +12 damage.',
 '노 핸드 시 데미지 +12.',
 '役なしの時ダメージ+12。',
 '无手牌时伤害+12。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "NoHand", "bonus": 12}',
 10),
...
('divine_blessing', 'Divine Blessing', '신의 축복', '神の祝福', '神圣祝福', 'Legendary',
 'Start battle with a shield that absorbs 25 damage.',
 '전투 시작 시 25 데미지를 흡수하는 보호막.',
 '戦闘開始時に25ダメージを吸収するシールド。',
 '战斗开始时获得吸收25伤害的护盾。',
 'BATTLE_START',
...
('ace_hunter', 'Ace Hunter', '에이스 헌터', 'エースハンター', '王牌猎手', 'Legendary',
 'Ace [1-1-1] deals +30 damage (total 90).',
 '에이스 [1-1-1] 완성 시 공격력 +30 (총 90).',
 'エース[1-1-1]完成時に攻撃力+30（合計90）。',
 'Ace[1-1-1]额外造成+30伤害（总计90）。',
 'BEFORE_DAMAGE',
 '{"type": "damage_bonus", "condition": "Ace", "bonus": 30}',
 15),
...
('chaos_lord', 'Chaos Lord', '혼돈의 군주', '混沌の君主', '混沌之主', 'Legendary',
 'Randomly apply one of: 2x damage, heal 15, skip enemy turn.',
 '랜덤하게 2배 데미지, 15 회복, 적 턴 스킵 중 하나 발동.',
 'ランダムで2倍ダメージ、15回復、敵ターンスキップのいずれかを発動。',
 '随机触发：2倍伤害、回复15、跳过敌人回合其一。',
 'AFTER_DAMAGE',
 '{"type": "random_effect", "effects": ["double_damage", "heal_15", "skip_turn"]}',
 15),
...
('omega_strike', 'Omega Strike', '오메가 스트라이크', 'オメガストライク', '欧米伽打击', 'Legendary',
 'If you win the turn by 40+ damage difference, enemy loses next turn.',
 '40 이상의 데미지 차이로 턴 승리 시 적 다음 턴 상실.',
 '40以上のダメージ差でターン勝利時、敵は次のターンを失う。',
 '伤害差超过40获胜时敌人失去下回合。',
 'AFTER_DAMAGE',
 '{"type": "overwhelming_victory", "threshold": 40}',
 15),

('phoenix_rebirth', 'Phoenix Rebirth', '불사조의 부활', 'フェニックスリバース', '凤凰重生', 'Legendary',
 'Once per battle, revive with 30 HP when reduced to 0.',
 '전투당 1회, HP가 0이 되면 30 HP로 부활.',
 '戦闘ごとに1回、HPが0になると30HPで復活。',
 '每场战斗1次，HP降至0时以30HP复活。',
 'PASSIVE',
 '{"type": "revive", "hp": 30, "uses": 1}',
 15),
